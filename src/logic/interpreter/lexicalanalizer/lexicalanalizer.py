...
class LexicalAnalizer:
    ...
    def s0(self):
        ...
        if (self.current_char.isspace()):
            ...
            self.update_lexeme()
            raise LexicalExceptionInvalidSymbol(self.lexeme, self.io_manager.get_line_number, self.io_manager.get_current_line(), self.io_manager.get_line_char_index)
    ...
    def s_comment(self):
        while(not self.is_enter(self.current_char) and not self.reachedEOF()):
            self.update_current_char()
        return self.s0()
    ...
    def s_equals(self):
        if (self.current_char == '='):
            ...
            raise LexicalExceptionInvalidOperator(self.lexeme, self.io_manager.get_line_number, self.io_manager.get_current_line(), self.io_manager.get_line_char_index)
